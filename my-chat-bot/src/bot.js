    ...
    function MyBot() {
        ...
        _this.onMessage(function (context, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, context.sendActivity("You said '" + context.activity.text + "'")];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _i = 0, membersAdded_1 = membersAdded;
                        _a.label = 1;
                    case 1:
                        if (!(_i < membersAdded_1.length)) return [3 /*break*/, 4];
                        member = membersAdded_1[_i];
                        if (!(member.id !== context.activity.recipient.id)) return [3 /*break*/, 3];
                        return [4 /*yield*/, context.sendActivity('Hello and welcome!')];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
